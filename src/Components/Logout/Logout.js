            ...
            <CardBody className="max-w-[100%]">
                <h2 className="text-center text-thirdColor text-xl font-bold pt-5 max-md:pt-0">هل انت متأكد من تسجيل الخروج؟ </h2>
                    <Link to='/'>
                        <button onClick={()=> {
                            setIsLoggedIn(true)
                            logout("https://task5-lina-sulaiman.trainees-mad-s.com/api/auth/logout/122")
                        }} className="bg-secondaryColor border-solid border-[1px] border-secondaryColor text-thirdColor rounded-2xl font-bold w-full h-10 mb-4 mt-4">تأكيد </button>
                    </Link>
                    <Link to='/'>
